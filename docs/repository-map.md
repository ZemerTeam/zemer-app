...
| Main activity | `.MainActivity`, exported, `launchMode="singleTask"`, `supportsPictureInPicture="true"`, `configChanges` covering `orientation`, `screenSize`, `smallestScreenSize`, `screenLayout`, `keyboardHidden`; handles launcher/`MUSIC_PLAYER`, `MEDIA_PLAY_FROM_SEARCH`, YouTube (`youtube.com`, `m.`/`www.`/`music.youtube.com`, `youtu.be`, `vnd.youtube`) and Zemer (`music.zemer.io`, `video.zemer.io`) deep links, and `SEND` of `text/plain`. |
...
| `app/src/main/kotlin/com/jtech/zemer/App.kt` | 409 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/MainActivity.kt` | 2498 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/LyricsHelper.kt` | 100 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/LyricsProviderRegistry.kt` | 46 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/LyricsUtils.kt` | 154 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/youtube/YouTubeSubtitleLyricsProvider.kt` | 21 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/lyrics/zemer/AppleTtmlLrc.kt` | 67 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/zemer/ZemerLyricsClient.kt` | 185 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/lyrics/zemer/ZemerLyricsProvider.kt` | 130 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 3284 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/ResumeShortcut.kt` | 19 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Player.kt` | 971 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/VideoPip.kt` | 111 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/ContentSettings.kt` | 664 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/LyricsProviderDialogs.kt` | 92 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/utils/LiveSong.kt` | 20 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/utils/UpdateChecker.kt` | 348 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/utils/updater/NightlyUpdates.kt` | 160 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/QuickPicksPresentation.kt` | 36 lines | `.kt` |
...
| `app/src/main/res/values/strings.xml` | 459 lines | `.xml` |
...
| `app/src/test/kotlin/com/jtech/zemer/lyrics/LyricsUtilsTest.kt` | 93 lines | `.kt` |
...
| `app/src/test/kotlin/com/jtech/zemer/lyrics/zemer/ZemerLyricsProviderTest.kt` | 245 lines | `.kt` |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/NotificationGateTest.kt` | 46 lines | `.kt` |
| `app/src/test/kotlin/com/jtech/zemer/playback/PlaybackNonceRegistryTest.kt` | 134 lines | `.kt` |
| `app/src/test/kotlin/com/jtech/zemer/playback/PlayerVideoUiLogicTest.kt` | 128 lines | `.kt` |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/ResumeShortcutTest.kt` | 26 lines | `.kt` |
...
| `app/src/test/kotlin/com/jtech/zemer/ui/screens/LoginGateRedirectTest.kt` | 30 lines | `.kt` |
...
| `app/src/test/kotlin/com/jtech/zemer/utils/updater/NightlyUpdatesTest.kt` | 223 lines | `.kt` |
| `app/src/test/kotlin/com/jtech/zemer/utils/updater/UpdateDownloadFailureTest.kt` | 61 lines | `.kt` |
| `app/src/test/kotlin/com/jtech/zemer/viewmodels/ArtistChannelEpisodesTest.kt` | 67 lines | `.kt` |
| `app/src/test/kotlin/com/jtech/zemer/viewmodels/QuickPicksPresentationTest.kt` | 49 lines | `.kt` |
...
| `docs/generate.py` | 1305 lines | `.py` |
| `docs/genres/README.md` | 99 lines | `.md` |
| `docs/home_rows/README.md` | 89 lines | `.md` |
| `docs/innertube/README.md` | 186 lines | `.md` |
| `docs/latest_releases/01-architecture-and-data-flow.md` | 80 lines | `.md` |
...
| `docs/lyrics/README.md` | 193 lines | `.md` |
| `docs/multi_update/01-architecture.md` | 56 lines | `.md` |
| `docs/multi_update/02-install-methods.md` | 74 lines | `.md` |
| `docs/multi_update/03-restart.md` | 41 lines | `.md` |
| `docs/multi_update/04-wiring.md` | 46 lines | `.md` |
| `docs/multi_update/05-runbook.md` | 51 lines | `.md` |
| `docs/multi_update/README.md` | 41 lines | `.md` |
| `docs/offline/README.md` | 131 lines | `.md` |
| `docs/podcasts/README.md` | 88 lines | `.md` |
| `docs/recognize_music/01-architecture-and-pipeline.md` | 65 lines | `.md` |
