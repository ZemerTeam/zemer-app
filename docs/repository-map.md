...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 984 lines | `.kt` |
...
| `docs/reference/kotlin-files.md` | 613 lines | `.md` |
...
| `docs/repository-map.md` | 1083 lines | `.md` |
