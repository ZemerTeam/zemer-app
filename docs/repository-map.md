...
| `app/build.gradle.kts` | 311 lines | `.kts` |
...
| `app/src/main/kotlin/com/jtech/zemer/MainActivity.kt` | 2270 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/statuses/StatusesApi.kt` | 221 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/statuses/StatusesRepository.kt` | 63 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/StatusCreatorCircle.kt` | 118 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/VerifiedBadge.kt` | 41 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/PlayerMenu.kt` | 504 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Player.kt` | 1365 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 1044 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeSeeAllScreen.kt` | 294 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeStatusesRow.kt` | 50 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/NavigationBuilder.kt` | 441 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/artist/ArtistItemsScreen.kt` | 269 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AppearanceSettings.kt` | 1078 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/statuses/StoryScreen.kt` | 483 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/utils/StatusNavigation.kt` | 9 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/StoryViewModel.kt` | 58 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/ZemerStatusesViewModel.kt` | 36 lines | `.kt` |
...
| `app/src/main/res/values/metrolist_strings.xml` | 575 lines | `.xml` |
...
| `app/src/test/kotlin/com/jtech/zemer/statuses/StatusesApiTest.kt` | 113 lines | `.kt` |
...
| `app/src/test/kotlin/com/jtech/zemer/ui/utils/StatusNavigationTest.kt` | 11 lines | `.kt` |
...
| `docs/reference/kotlin-files.md` | 644 lines | `.md` |
...
| `docs/repository-map.md` | 1145 lines | `.md` |
