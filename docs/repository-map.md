...
| `app/src/main/kotlin/com/jtech/zemer/App.kt` | 508 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/MainActivity.kt` | 2254 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 2133 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/PlayerConnection.kt` | 329 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/queues/ZemerRadioQueue.kt` | 91 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/search/SearchProvider.kt` | 45 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/search/ZemerResultMapper.kt` | 387 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/search/ZemerSearchClient.kt` | 323 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/search/ZemerSearchRepository.kt` | 300 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/tracking/PlaySource.kt` | 65 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/PlayerMenu.kt` | 493 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/LyricsScreen.kt` | 754 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Player.kt` | 1390 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/AlbumScreen.kt` | 647 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/BrowseScreen.kt` | 143 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/ChartsScreen.kt` | 300 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HistoryScreen.kt` | 515 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 919 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/StatsScreen.kt` | 419 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/YouTubeBrowseScreen.kt` | 282 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/artist/ArtistSectionScreen.kt` | 153 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/playlist/LocalPlaylistScreen.kt` | 1430 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/playlist/OnlinePlaylistScreen.kt` | 672 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/search/OnlineSearchResult.kt` | 532 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/AlbumViewModel.kt` | 80 lines | `.kt` |
...
| `app/src/main/res/values/metrolist_strings.xml` | 565 lines | `.xml` |
...
| `app/src/test/kotlin/com/jtech/zemer/search/SearchProviderTest.kt` | 65 lines | `.kt` |
...
| `docs/home_rows/README.md` | 91 lines | `.md` |
...
| `docs/repository-map.md` | 1078 lines | `.md` |
