...
| `app/src/main/kotlin/com/jtech/zemer/MainActivity.kt` | 2297 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/constants/PreferenceKeys.kt` | 582 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/db/DatabaseDao.kt` | 1638 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/models/MediaMetadata.kt` | 114 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MediaStoreDownloadManager.kt` | 795 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/MediaStoreDownloadService.kt` | 302 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 2409 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/PlayerConnection.kt` | 356 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoModeController.kt` | 457 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoModeLogic.kt` | 188 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoRendition.kt` | 35 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoSongIds.kt` | 25 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/search/ZemerResultMapper.kt` | 501 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/ArtistBrowseComponents.kt` | 198 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/Items.kt` | 1605 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/OnboardingActionButton.kt` | 82 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/StatusStoryTopOverlay.kt` | 129 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/ArtistMenu.kt` | 261 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Player.kt` | 1424 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/player/PlayerBackground.kt` | 116 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/player/PlayerVideoFullscreen.kt` | 245 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/player/PlayerVideoSurface.kt` | 45 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Thumbnail.kt` | 565 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/player/VideoModePill.kt` | 141 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/AccountScreen.kt` | 192 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/GenreScreen.kt` | 599 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 1055 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeSeeAllScreen.kt` | 303 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/LoginGateScreen.kt` | 241 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/LoginScreen.kt` | 244 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/NavigationBuilder.kt` | 438 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/ContentFiltersScreen.kt` | 464 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/DensityScreen.kt` | 293 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/OnboardingChoiceCard.kt` | 93 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/OnboardingSearchBackupScreen.kt` | 99 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/PermissionsScreen.kt` | 397 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/WelcomeScreen.kt` | 219 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/playlist/DownloadedContentScreen.kt` | 108 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AppearanceSettings.kt` | 1105 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/statuses/SavedStatusScreen.kt` | 348 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/statuses/StoryScreen.kt` | 920 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/utils/AppNavigation.kt` | 31 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/utils/ShowMediaInfo.kt` | 187 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/AutoPlaylistViewModel.kt` | 78 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/DownloadedContentViewModel.kt` | 44 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/LibraryViewModels.kt` | 459 lines | `.kt` |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/VideoRenditionTest.kt` | 22 lines | `.kt` |
...
| `app/src/test/kotlin/com/jtech/zemer/ui/utils/AppNavigationTest.kt` | 39 lines | `.kt` |
...
| `docs/reference/kotlin-files.md` | 704 lines | `.md` |
...
| `docs/repository-map.md` | 1209 lines | `.md` |
...
| `innertube/src/main/kotlin/com/metrolist/innertube/YouTube.kt` | 1140 lines | `.kt` |
