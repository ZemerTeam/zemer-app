...
| `app/src/main/kotlin/com/jtech/zemer/MainActivity.kt` | 2423 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AppearanceSettings.kt` | 1098 lines | `.kt` |
...
| `docs/repository-map.md` | 1322 lines | `.md` |
