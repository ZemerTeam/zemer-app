...
| `app/src/main/kotlin/com/jtech/zemer/MainActivity.kt` | 2425 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/constants/PreferenceKeys.kt` | 626 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/db/DatabaseDao.kt` | 1765 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/extensions/ListExt.kt` | 30 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/latestreleases/LatestReleaseCard.kt` | 113 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/offline/SubsetCorpus.kt` | 175 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MediaStoreDownloadManager.kt` | 1198 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/MediaStoreDownloadService.kt` | 302 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 3075 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoModeController.kt` | 891 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/queues/Queue.kt` | 111 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrBuffer.kt` | 101 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrDataSource.kt` | 174 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrMessages.kt` | 180 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrPlayerResolver.kt` | 196 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrProto.kt` | 101 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrSession.kt` | 187 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrStreamResolver.kt` | 164 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrUmp.kt` | 71 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrVideoResolver.kt` | 384 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrVideoSession.kt` | 199 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrVideoStream.kt` | 160 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/sync/UserPreferencesRepository.kt` | 694 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/PressBounce.kt` | 58 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 1539 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/NavigationBuilder.kt` | 511 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/library/LibraryAlbumsScreen.kt` | 320 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AccountSettings.kt` | 517 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AndroidAutoSettings.kt` | 273 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AppearanceSettings.kt` | 1124 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/ContentSettings.kt` | 724 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/StreamSourceSettings.kt` | 332 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/utils/ShowMediaInfo.kt` | 217 lines | `.kt` |
...
| `app/src/main/res/values/metrolist_strings.xml` | 709 lines | `.xml` |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/sabr/SabrAudioPickTest.kt` | 46 lines | `.kt` |
| `app/src/test/kotlin/com/jtech/zemer/playback/sabr/SabrBufferTest.kt` | 124 lines | `.kt` |
| `app/src/test/kotlin/com/jtech/zemer/playback/sabr/SabrMessagesTest.kt` | 150 lines | `.kt` |
...
| `docs/reference/kotlin-files.md` | 812 lines | `.md` |
...
| `docs/repository-map.md` | 1348 lines | `.md` |
| `docs/sabr/README.md` | 449 lines | `.md` |
...
| `innertube/src/main/kotlin/com/metrolist/innertube/YouTube.kt` | 1002 lines | `.kt` |
...
| `tests/sabr-video.mjs` | 179 lines | `.mjs` |
