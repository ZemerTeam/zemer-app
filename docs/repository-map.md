...
| `app/src/github/kotlin/com/jtech/zemer/accessibility/ButtonMapperAccessibilityService.kt` | 45 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/distribution/AccessibilityIntegration.kt` | 22 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/distribution/UpdateIntegration.kt` | 192 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/ui/component/UpdateDownloadDialog.kt` | 129 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/ui/screens/settings/ButtonSetupScreen.kt` | 374 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/ui/screens/settings/UpdaterSettings.kt` | 328 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/utils/AccessibilityUtils.kt` | 91 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/utils/ButtonMapperBridge.kt` | 35 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/utils/UpdateChecker.kt` | 155 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/utils/Updater.kt` | 55 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/ApkInstallController.kt` | 102 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/AppInstaller.kt` | 267 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/AppRestarter.kt` | 30 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/InstallReceiver.kt` | 70 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/Installer.kt` | 24 lines | `.kt` |
| `app/src/github/kotlin/com/jtech/zemer/viewmodels/ButtonSetupViewModel.kt` | 159 lines | `.kt` |
| `app/src/github/res/xml/accessibility_service_config.xml` | 9 lines | `.xml` |
...
| `app/src/main/kotlin/com/jtech/zemer/App.kt` | 416 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/MainActivity.kt` | 2037 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 1672 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/Items.kt` | 1618 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/AlbumMenu.kt` | 457 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/ArtistMenu.kt` | 272 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/PlayerMenu.kt` | 514 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/PlaylistMenu.kt` | 221 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/ReportContentDialog.kt` | 130 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/SelectionSongsMenu.kt` | 743 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/SongMenu.kt` | 633 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/YouTubeAlbumMenu.kt` | 398 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 1040 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/NavigationBuilder.kt` | 348 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/NewReleaseScreen.kt` | 254 lines | `.kt` |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/OnboardingScreen.kt` | 2075 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AccountSettings.kt` | 425 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/SettingsScreen.kt` | 266 lines | `.kt` |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/HomeViewModel.kt` | 1537 lines | `.kt` |
...
| `app/src/main/res/values/metrolist_strings.xml` | 552 lines | `.xml` |
...
| `app/src/play/AndroidManifest.xml` | 49 lines | `.xml` |
| `app/src/play/kotlin/com/jtech/zemer/distribution/AccessibilityIntegration.kt` | 16 lines | `.kt` |
| `app/src/play/kotlin/com/jtech/zemer/distribution/UpdateIntegration.kt` | 31 lines | `.kt` |
| `app/src/play/kotlin/com/jtech/zemer/utils/ButtonMapperBridge.kt` | 15 lines | `.kt` |
...
| `docs/play/PLAN.md` | 447 lines | `.md` |
| `docs/play/data-safety.md` | 50 lines | `.md` |
| `docs/play/privacy-policy.md` | 91 lines | `.md` |
...
| `docs/reference/kotlin-files.md` | 469 lines | `.md` |
| `docs/reference/non-kotlin-files.md` | 358 lines | `.md` |
...
| `docs/repository-map.md` | 945 lines | `.md` |
