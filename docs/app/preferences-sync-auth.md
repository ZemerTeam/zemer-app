...
<!-- generated:pref-keys - regenerated by docs/generate.py; edit the generator, not this block -->
...
<!-- generated:pref-keys-elsewhere - regenerated by docs/generate.py; edit the generator, not this block -->
...
<!-- /generated:pref-keys-elsewhere -->

## Auth/sync/preference Kotlin files

Declarations are capped at 25 per file (same extraction as `reference/kotlin-files.md`).

<!-- generated:prefs-files - regenerated by docs/generate.py; edit the generator, not this block -->
