...
| `app/src/main/res/values/metrolist_strings.xml` | 539 lines | text `.xml`; XML root `resources` |
| `app/src/main/res/values/strings.xml` | 448 lines | text `.xml`; XML root `resources` |
