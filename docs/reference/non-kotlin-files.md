...
| `.github/workflows/player-monitor.yml` | 126 lines | text `.yml` |
...
| `app/build.gradle.kts` | 281 lines | text `.kts`; plugins `com.android.application, android, hilt, kotlin.ksp, compose.compiler, google.gms.google.services, firebase.crashlytics, rikka.tools.refine` |
...
| `app/src/main/res/values/metrolist_strings.xml` | 339 lines | text `.xml`; XML root `resources` |
