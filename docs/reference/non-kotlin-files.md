...
| `app/src/main/res/values-iw/strings.xml` | 271 lines | text `.xml`; XML root `resources` |
...
| `app/src/main/res/values/strings.xml` | 425 lines | text `.xml`; XML root `resources` |
