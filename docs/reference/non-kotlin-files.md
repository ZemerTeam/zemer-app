...
| `app/src/main/res/values/metrolist_strings.xml` | 702 lines | text `.xml`; XML root `resources` |
...
| `tests/video-qualities.mjs` | 279 lines | text `.mjs` |
