...
| `app/src/main/kotlin/com/jtech/zemer/constants/PreferenceKeys.kt` | 582 | `com.jtech.zemer.constants` | no | 9 | 180 | androidx.annotation, androidx.datastore, java.time |
...
| `app/src/main/kotlin/com/jtech/zemer/db/DatabaseDao.kt` | 1638 | `com.jtech.zemer.db` | no | 62 | 219 | androidx.room, androidx.sqlite, java.text, java.time, java.util, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/models/MediaMetadata.kt` | 114 | `com.jtech.zemer.models` | no | 8 | 24 | androidx.compose, java.io, java.time |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/DownloadUtil.kt` | 328 | `com.jtech.zemer.playback` | no | 45 | 43 | android.content, android.net, androidx.core, androidx.media3, dagger.hilt, java.time, java.util, javax.inject, kotlinx.coroutines, okhttp3.OkHttpClient |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MediaStoreDownloadManager.kt` | 795 | `com.jtech.zemer.playback` | no | 42 | 98 | android.content, android.net, androidx.core, dagger.hilt, java.io, java.time, java.util, javax.inject, kotlin.math, kotlinx.coroutines, okhttp3.OkHttpClient, okhttp3.Request, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 2409 | `com.jtech.zemer.playback` | no | 173 | 250 | android.app, android.content, android.media, android.net, android.os, androidx.core, androidx.datastore, androidx.media3, com.zemer, dagger.hilt, java.io, java.sql, java.time, java.util, javax.inject, kotlin.time, kotlinx.coroutines, okhttp3.OkHttpClient, org.fcast, timber.log |
| `app/src/main/kotlin/com/jtech/zemer/playback/PlayerConnection.kt` | 356 | `com.jtech.zemer.playback` | no | 27 | 60 | android.content, androidx.media3, kotlinx.coroutines, org.fcast |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoModeController.kt` | 457 | `com.jtech.zemer.playback` | no | 31 | 68 | android.os, android.view, androidx.media3, kotlinx.coroutines, org.fcast |
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoModeLogic.kt` | 188 | `com.jtech.zemer.playback` | no | 1 | 11 |  |
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoRendition.kt` | 35 | `com.jtech.zemer.playback` | no | 0 | 8 |  |
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoSongIds.kt` | 25 | `com.jtech.zemer.playback` | no | 0 | 6 |  |
...
| `app/src/main/kotlin/com/jtech/zemer/search/ZemerResultMapper.kt` | 501 | `com.jtech.zemer.search` | no | 18 | 66 |  |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/ArtistBrowseComponents.kt` | 198 | `com.jtech.zemer.ui.component` | yes | 38 | 5 | androidx.compose |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/Items.kt` | 1605 | `com.jtech.zemer.ui.component` | yes | 111 | 90 | android.annotation, androidx.compose, androidx.media3, coil3.compose, coil3.request, kotlin.math, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/OnboardingActionButton.kt` | 82 | `com.jtech.zemer.ui.component` | yes | 11 | 3 | androidx.compose |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/PlayerMenu.kt` | 513 | `com.jtech.zemer.ui.menu` | yes | 75 | 33 | android.content, android.media, androidx.activity, androidx.annotation, androidx.compose, androidx.media3, androidx.navigation, kotlin.math, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Player.kt` | 1424 | `com.jtech.zemer.ui.player` | yes | 147 | 106 | android.annotation, android.app, android.content, androidx.compose, androidx.core, androidx.media3, androidx.navigation, coil3.compose, coil3.request, kotlin.math, kotlinx.coroutines, me.saket |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/PlayerVideoFullscreen.kt` | 245 | `com.jtech.zemer.ui.player` | yes | 52 | 15 | android.app, android.content, androidx.activity, androidx.compose, androidx.core, androidx.media3, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/ui/player/PlayerVideoSurface.kt` | 45 | `com.jtech.zemer.ui.player` | yes | 8 | 4 | android.view, androidx.compose |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Thumbnail.kt` | 565 | `com.jtech.zemer.ui.player` | yes | 82 | 59 | androidx.compose, androidx.media3, coil3.compose, kotlin.math, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/ui/player/VideoModePill.kt` | 141 | `com.jtech.zemer.ui.player` | yes | 30 | 7 | androidx.annotation, androidx.compose |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/GenreScreen.kt` | 599 | `com.jtech.zemer.ui.screens` | yes | 103 | 27 | androidx.compose, androidx.hilt, androidx.navigation, coil3.compose, coil3.request, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 1055 | `com.jtech.zemer.ui.screens` | yes | 121 | 74 | android.net, androidx.compose, androidx.hilt, androidx.lifecycle, androidx.navigation, kotlin.math, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeSeeAllScreen.kt` | 303 | `com.jtech.zemer.ui.screens` | yes | 59 | 29 | androidx.compose, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/LoginGateScreen.kt` | 241 | `com.jtech.zemer.ui.screens` | yes | 52 | 23 | androidx.compose, androidx.navigation, io.ktor, kotlinx.coroutines, kotlinx.serialization |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/NavigationBuilder.kt` | 438 | `com.jtech.zemer.ui.screens` | no | 52 | 5 | androidx.compose, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/artist/ArtistScreen.kt` | 861 | `com.jtech.zemer.ui.screens.artist` | yes | 124 | 46 | androidx.compose, androidx.hilt, androidx.navigation, coil3.compose, com.valentinilk |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/ContentFiltersScreen.kt` | 464 | `com.jtech.zemer.ui.screens.onboarding` | yes | 61 | 23 | androidx.activity, androidx.compose, androidx.datastore, androidx.hilt, com.google, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/DensityScreen.kt` | 293 | `com.jtech.zemer.ui.screens.onboarding` | yes | 42 | 18 | android.content, androidx.compose, androidx.core, androidx.datastore |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/OnboardingChoiceCard.kt` | 93 | `com.jtech.zemer.ui.screens.onboarding` | yes | 21 | 2 | androidx.compose |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/OnboardingSearchBackupScreen.kt` | 99 | `com.jtech.zemer.ui.screens.onboarding` | yes | 24 | 2 | androidx.compose, androidx.hilt |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/onboarding/PermissionsScreen.kt` | 397 | `com.jtech.zemer.ui.screens.onboarding` | yes | 52 | 29 | android.Manifest, android.annotation, android.content, android.net, android.os, android.provider, androidx.activity, androidx.compose, androidx.core, androidx.lifecycle, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/playlist/DownloadedContentScreen.kt` | 108 | `com.jtech.zemer.ui.screens.playlist` | yes | 29 | 6 | androidx.compose, androidx.hilt, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/search/OnlineSearchResult.kt` | 463 | `com.jtech.zemer.ui.screens.search` | yes | 83 | 31 | androidx.compose, androidx.hilt, androidx.navigation, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AppearanceSettings.kt` | 1105 | `com.jtech.zemer.ui.screens.settings` | yes | 122 | 104 | android.annotation, android.content, androidx.compose, androidx.core, androidx.navigation, kotlin.math, kotlinx.coroutines, me.saket |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/statuses/SavedStatusScreen.kt` | 348 | `com.jtech.zemer.ui.screens.statuses` | yes | 61 | 38 | androidx.activity, androidx.compose, androidx.core, androidx.hilt, androidx.lifecycle, androidx.media3, androidx.navigation, coil3.compose, coil3.request, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/AutoPlaylistViewModel.kt` | 78 | `com.jtech.zemer.viewmodels` | no | 24 | 11 | android.content, androidx.lifecycle, dagger.hilt, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/DownloadedContentViewModel.kt` | 44 | `com.jtech.zemer.viewmodels` | no | 16 | 4 | android.content, androidx.lifecycle, dagger.hilt, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/LibraryViewModels.kt` | 459 | `com.jtech.zemer.viewmodels` | no | 59 | 63 | android.content, androidx.lifecycle, dagger.hilt, java.time, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/OnlineSearchViewModel.kt` | 262 | `com.jtech.zemer.viewmodels` | no | 35 | 31 | android.content, android.net, androidx.compose, androidx.lifecycle, dagger.hilt, javax.inject, kotlinx.coroutines |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/VideoRenditionTest.kt` | 22 | `com.jtech.zemer.playback` | no | 4 | 2 | org.junit |
...
| `innertube/src/main/kotlin/com/metrolist/innertube/YouTube.kt` | 1140 | `com.metrolist.innertube` | no | 63 | 178 | io.ktor, java.net, kotlin.random, kotlinx.coroutines, kotlinx.serialization |
