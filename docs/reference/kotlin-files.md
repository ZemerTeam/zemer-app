...
| `app/src/main/kotlin/com/jtech/zemer/constants/PreferenceKeys.kt` | 650 | `com.jtech.zemer.constants` | no | 9 | 188 | androidx.annotation, androidx.datastore, java.time |
| `app/src/main/kotlin/com/jtech/zemer/db/Converters.kt` | 20 | `com.jtech.zemer.db` | no | 4 | 3 | androidx.room, java.time |
| `app/src/main/kotlin/com/jtech/zemer/db/DatabaseDao.kt` | 1804 | `com.jtech.zemer.db` | no | 65 | 246 | androidx.room, androidx.sqlite, java.text, java.time, java.util, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MediaStoreDownloadManager.kt` | 1221 | `com.jtech.zemer.playback` | no | 66 | 144 | android.content, android.media, android.net, androidx.core, dagger.hilt, java.io, java.time, java.util, javax.inject, kotlin.math, kotlinx.coroutines, okhttp3.OkHttpClient, okhttp3.Request, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 3113 | `com.jtech.zemer.playback` | no | 191 | 325 | android.app, android.content, android.database, android.media, android.net, android.os, androidx.core, androidx.datastore, androidx.media3, com.zemer, dagger.hilt, java.io, java.time, java.util, javax.inject, kotlin.time, kotlinx.coroutines, okhttp3.OkHttpClient, org.fcast, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrSession.kt` | 235 | `com.jtech.zemer.playback.sabr` | no | 5 | 71 | okhttp3.MediaType, okhttp3.OkHttpClient, okhttp3.Request, okhttp3.RequestBody, timber.log |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrSpool.kt` | 134 | `com.jtech.zemer.playback.sabr` | no | 3 | 37 | java.io, java.util, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrVideoSession.kt` | 263 | `com.jtech.zemer.playback.sabr` | no | 5 | 91 | okhttp3.MediaType, okhttp3.OkHttpClient, okhttp3.Request, okhttp3.RequestBody, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Player.kt` | 1242 | `com.jtech.zemer.ui.player` | yes | 152 | 99 | android.annotation, android.app, android.content, androidx.compose, androidx.core, androidx.media3, androidx.navigation, coil3.compose, coil3.request, kotlinx.coroutines, me.saket |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/StreamSourceSettings.kt` | 320 | `com.jtech.zemer.ui.screens.settings` | yes | 59 | 28 | androidx.compose, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/utils/YTPlayerUtils.kt` | 801 | `com.jtech.zemer.utils` | no | 32 | 102 | android.net, androidx.core, androidx.media3, com.zemer, kotlinx.coroutines, okhttp3.OkHttpClient, timber.log |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/sabr/SabrStreamLifecycleTest.kt` | 205 | `com.jtech.zemer.playback.sabr` | no | 11 | 31 | okhttp3.OkHttpClient, org.junit |
