...
| `app/src/main/kotlin/com/jtech/zemer/constants/PreferenceKeys.kt` | 663 | `com.jtech.zemer.constants` | no | 9 | 198 | androidx.annotation, androidx.datastore, java.time |
...
| `app/src/main/kotlin/com/jtech/zemer/db/entities/LyricsEntity.kt` | 59 | `com.jtech.zemer.db.entities` | no | 2 | 12 | androidx.room |
...
| `app/src/main/kotlin/com/jtech/zemer/di/LyricsStoreEntryPoint.kt` | 13 | `com.jtech.zemer.di` | no | 4 | 2 | dagger.hilt |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/LyricsHelper.kt` | 102 | `com.jtech.zemer.lyrics` | no | 15 | 15 | android.content, androidx.datastore, dagger.hilt, javax.inject, kotlinx.coroutines, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/LyricsProviderRegistry.kt` | 49 | `com.jtech.zemer.lyrics` | no | 6 | 9 |  |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/lrclib/LrcLib.kt` | 200 | `com.jtech.zemer.lyrics.lrclib` | no | 5 | 35 | io.ktor, kotlin.math |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/simpmusic/SimpMusicLyrics.kt` | 124 | `com.jtech.zemer.lyrics.simpmusic` | no | 8 | 18 | io.ktor, kotlin.math |
| `app/src/main/kotlin/com/jtech/zemer/lyrics/simpmusic/SimpMusicLyricsProvider.kt` | 21 | `com.jtech.zemer.lyrics.simpmusic` | no | 2 | 5 |  |
| `app/src/main/kotlin/com/jtech/zemer/lyrics/simpmusic/SimpMusicModels.kt` | 29 | `com.jtech.zemer.lyrics.simpmusic` | no | 2 | 10 | kotlinx.serialization |
| `app/src/main/kotlin/com/jtech/zemer/lyrics/youtube/YouTubeLyricsProvider.kt` | 31 | `com.jtech.zemer.lyrics.youtube` | no | 5 | 6 |  |
| `app/src/main/kotlin/com/jtech/zemer/lyrics/youtube/YouTubeSubtitleLyricsProvider.kt` | 21 | `com.jtech.zemer.lyrics.youtube` | no | 3 | 5 |  |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/zemer/LineTimesLrc.kt` | 90 | `com.jtech.zemer.lyrics.zemer` | no | 2 | 27 | java.security, java.text |
...
| `app/src/main/kotlin/com/jtech/zemer/lyrics/zemer/ZemerLyricsClient.kt` | 194 | `com.jtech.zemer.lyrics.zemer` | no | 20 | 84 | io.ktor, kotlinx.serialization |
| `app/src/main/kotlin/com/jtech/zemer/lyrics/zemer/ZemerLyricsProvider.kt` | 133 | `com.jtech.zemer.lyrics.zemer` | no | 8 | 19 | kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/ResumeShortcut.kt` | 19 | `com.jtech.zemer.playback` | no | 0 | 3 |  |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/playlist/LocalPlaylistScreen.kt` | 1260 | `com.jtech.zemer.ui.screens.playlist` | yes | 146 | 82 | android.annotation, android.content, android.graphics, android.net, androidx.activity, androidx.compose, androidx.core, androidx.hilt, androidx.lifecycle, androidx.navigation, coil3.compose, coil3.request, com.yalantis, io.ktor, java.time, kotlinx.coroutines, sh.calvin |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AndroidAutoSettings.kt` | 262 | `com.jtech.zemer.ui.screens.settings` | yes | 52 | 29 | androidx.compose, androidx.lifecycle, androidx.navigation, kotlinx.coroutines, sh.calvin |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/ContentSettings.kt` | 669 | `com.jtech.zemer.ui.screens.settings` | yes | 94 | 72 | android.content, android.os, android.provider, androidx.activity, androidx.compose, androidx.core, androidx.hilt, androidx.navigation, com.google, dagger.hilt, java.text, java.util, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/LyricsProviderDialogs.kt` | 114 | `com.jtech.zemer.ui.screens.settings` | yes | 24 | 17 | androidx.compose |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/PrivacySettings.kt` | 158 | `com.jtech.zemer.ui.screens.settings` | yes | 38 | 10 | androidx.compose, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/UpdaterSettings.kt` | 408 | `com.jtech.zemer.ui.screens.settings` | yes | 68 | 29 | android.content, androidx.compose, androidx.navigation, java.io, kotlinx.coroutines, rikka.shizuku, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/utils/LiveSong.kt` | 20 | `com.jtech.zemer.ui.utils` | yes | 5 | 2 | androidx.compose |
...
| `app/src/main/kotlin/com/jtech/zemer/utils/updater/NightlyUpdates.kt` | 160 | `com.jtech.zemer.utils.updater` | no | 7 | 42 | kotlinx.serialization |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/LatestReleasesViewModel.kt` | 83 | `com.jtech.zemer.viewmodels` | no | 22 | 10 | android.content, androidx.lifecycle, dagger.hilt, javax.inject, kotlinx.coroutines, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/LyricsLineExtrasViewModel.kt` | 61 | `com.jtech.zemer.viewmodels` | no | 19 | 11 | androidx.lifecycle, dagger.hilt, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/QuickPicksPresentation.kt` | 36 | `com.jtech.zemer.viewmodels` | no | 0 | 7 |  |
...
| `app/src/test/kotlin/com/jtech/zemer/lyrics/simpmusic/SimpMusicLyricsTest.kt` | 102 | `com.jtech.zemer.lyrics.simpmusic` | no | 5 | 2 | org.junit |
...
| `app/src/test/kotlin/com/jtech/zemer/lyrics/zemer/ZemerLyricsClientParseTest.kt` | 92 | `com.jtech.zemer.lyrics.zemer` | no | 6 | 13 | kotlinx.serialization, org.junit |
| `app/src/test/kotlin/com/jtech/zemer/lyrics/zemer/ZemerLyricsProviderTest.kt` | 261 | `com.jtech.zemer.lyrics.zemer` | no | 4 | 58 | kotlinx.coroutines, org.junit |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/NotificationGateTest.kt` | 46 | `com.jtech.zemer.playback` | no | 3 | 1 | org.junit |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/PlayerVideoUiLogicTest.kt` | 128 | `com.jtech.zemer.playback` | no | 3 | 3 | org.junit |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/ResumeShortcutTest.kt` | 26 | `com.jtech.zemer.playback` | no | 2 | 1 | org.junit |
...
| `app/src/test/kotlin/com/jtech/zemer/ui/screens/LoginGateRedirectTest.kt` | 30 | `com.jtech.zemer.ui.screens` | no | 3 | 1 | org.junit |
...
| `app/src/test/kotlin/com/jtech/zemer/utils/updater/NightlyUpdatesTest.kt` | 223 | `com.jtech.zemer.utils.updater` | no | 10 | 25 | java.security, kotlinx.serialization, org.junit |
| `app/src/test/kotlin/com/jtech/zemer/utils/updater/UpdateDownloadFailureTest.kt` | 61 | `com.jtech.zemer.utils.updater` | no | 7 | 3 | io.ktor, java.io, java.net, org.junit |
...
| `app/src/test/kotlin/com/jtech/zemer/viewmodels/QuickPicksPresentationTest.kt` | 49 | `com.jtech.zemer.viewmodels` | no | 4 | 5 | org.junit |
