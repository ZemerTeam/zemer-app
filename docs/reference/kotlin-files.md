...
| `app/src/main/kotlin/com/jtech/zemer/constants/Dimensions.kt` | 33 | `com.jtech.zemer.constants` | no | 4 | 19 | androidx.compose |
...
| `app/src/main/kotlin/com/jtech/zemer/latestreleases/LatestReleasePlayback.kt` | 81 | `com.jtech.zemer.latestreleases` | no | 8 | 10 | androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/CastPlayback.kt` | 80 | `com.jtech.zemer.playback` | no | 1 | 11 | org.fcast |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/CastVolumeKeys.kt` | 46 | `com.jtech.zemer.playback` | no | 1 | 7 | android.view |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/FCastDiscoveryHandler.kt` | 384 | `com.jtech.zemer.playback` | no | 5 | 72 | kotlinx.coroutines, org.fcast |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 2189 | `com.jtech.zemer.playback` | no | 168 | 230 | android.app, android.content, android.media, android.net, android.os, android.widget, androidx.core, androidx.datastore, androidx.media3, com.zemer, dagger.hilt, java.io, java.sql, java.time, java.util, javax.inject, kotlin.time, kotlinx.coroutines, okhttp3.OkHttpClient, org.fcast, timber.log |
| `app/src/main/kotlin/com/jtech/zemer/playback/PlayerConnection.kt` | 313 | `com.jtech.zemer.playback` | no | 27 | 55 | android.content, androidx.media3, kotlinx.coroutines, org.fcast |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoModeController.kt` | 348 | `com.jtech.zemer.playback` | no | 28 | 60 | android.os, android.view, androidx.media3, kotlinx.coroutines, org.fcast |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/queues/LocalAlbumRadio.kt` | 69 | `com.jtech.zemer.playback.queues` | no | 12 | 17 | androidx.media3, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/playback/queues/Queue.kt` | 62 | `com.jtech.zemer.playback.queues` | no | 4 | 15 | androidx.media3 |
...
| `app/src/main/kotlin/com/jtech/zemer/search/ZemerResultMapper.kt` | 286 | `com.jtech.zemer.search` | no | 16 | 35 |  |
...
| `app/src/main/kotlin/com/jtech/zemer/search/ZemerSearchModels.kt` | 164 | `com.jtech.zemer.search` | no | 2 | 68 | kotlinx.serialization |
| `app/src/main/kotlin/com/jtech/zemer/search/ZemerSearchOptions.kt` | 32 | `com.jtech.zemer.search` | no | 5 | 6 | android.content |
| `app/src/main/kotlin/com/jtech/zemer/search/ZemerSearchRepository.kt` | 168 | `com.jtech.zemer.search` | no | 19 | 36 | android.content, dagger.hilt, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/CastVolumeKeyHandler.kt` | 66 | `com.jtech.zemer.ui.component` | yes | 13 | 6 | androidx.compose |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/Items.kt` | 1594 | `com.jtech.zemer.ui.component` | yes | 109 | 88 | android.annotation, android.widget, androidx.compose, androidx.media3, coil3.compose, coil3.request, kotlin.math, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/PlayerMenu.kt` | 497 | `com.jtech.zemer.ui.menu` | yes | 72 | 33 | android.content, android.media, android.widget, androidx.activity, androidx.annotation, androidx.compose, androidx.media3, androidx.navigation, kotlin.math, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/SongMenu.kt` | 553 | `com.jtech.zemer.ui.menu` | yes | 76 | 39 | android.content, android.widget, androidx.activity, androidx.compose, androidx.hilt, androidx.navigation, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/YouTubeArtistMenu.kt` | 207 | `com.jtech.zemer.ui.menu` | yes | 39 | 8 | android.content, androidx.compose |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/YouTubePlaylistMenu.kt` | 481 | `com.jtech.zemer.ui.menu` | yes | 74 | 23 | android.annotation, android.content, androidx.compose, coil3.compose, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/YouTubeSongMenu.kt` | 472 | `com.jtech.zemer.ui.menu` | yes | 79 | 28 | android.annotation, android.content, androidx.compose, androidx.navigation, coil3.compose, java.time, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Player.kt` | 1452 | `com.jtech.zemer.ui.player` | yes | 147 | 110 | android.annotation, android.app, android.content, android.widget, androidx.compose, androidx.core, androidx.media3, androidx.navigation, coil3.compose, coil3.request, kotlin.math, kotlinx.coroutines, me.saket |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/player/Thumbnail.kt` | 557 | `com.jtech.zemer.ui.player` | yes | 82 | 57 | androidx.compose, androidx.media3, coil3.compose, kotlin.math, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 983 | `com.jtech.zemer.ui.screens` | yes | 107 | 63 | android.net, androidx.compose, androidx.hilt, androidx.navigation, kotlin.math, kotlin.random, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/NavigationBuilder.kt` | 371 | `com.jtech.zemer.ui.screens` | no | 44 | 1 | androidx.compose, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/artist/ArtistItemsScreen.kt` | 324 | `com.jtech.zemer.ui.screens.artist` | yes | 60 | 18 | androidx.compose, androidx.hilt, androidx.navigation |
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/artist/ArtistScreen.kt` | 870 | `com.jtech.zemer.ui.screens.artist` | yes | 120 | 46 | android.content, android.widget, androidx.compose, androidx.hilt, androidx.navigation, coil3.compose, com.valentinilk |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/library/LibraryVideosScreen.kt` | 167 | `com.jtech.zemer.ui.screens.library` | yes | 42 | 10 | androidx.compose, androidx.hilt, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/playlist/DownloadedVideosScreen.kt` | 501 | `com.jtech.zemer.ui.screens.playlist` | yes | 92 | 24 | androidx.activity, androidx.compose, androidx.hilt, androidx.navigation, coil3.compose |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/playlist/OnlinePlaylistScreen.kt` | 669 | `com.jtech.zemer.ui.screens.playlist` | yes | 107 | 29 | androidx.activity, androidx.compose, androidx.hilt, androidx.navigation, coil3.compose, coil3.request |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/playlist/ZemerCuratedPlaylistScreen.kt` | 396 | `com.jtech.zemer.ui.screens.playlist` | yes | 78 | 18 | androidx.compose, androidx.hilt, androidx.navigation, coil3.compose, coil3.request |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/search/OnlineSearchResult.kt` | 479 | `com.jtech.zemer.ui.screens.search` | yes | 85 | 32 | androidx.compose, androidx.hilt, androidx.navigation, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/OnlineSearchViewModel.kt` | 369 | `com.jtech.zemer.viewmodels` | no | 44 | 47 | android.content, android.net, androidx.compose, androidx.lifecycle, dagger.hilt, javax.inject, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/OnlineSearchViewModel.kt` | 369 | `com.jtech.zemer.viewmodels` | no | 44 | 47 | android.content, android.net, androidx.compose, androidx.lifecycle, dagger.hilt, javax.inject, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/OnlineSearchViewModel.kt` | 369 | `com.jtech.zemer.viewmodels` | no | 44 | 47 | android.content, android.net, androidx.compose, androidx.lifecycle, dagger.hilt, javax.inject, kotlinx.coroutines |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/CastPlaybackTest.kt` | 137 | `com.jtech.zemer.playback` | no | 6 | 1 | org.fcast, org.junit |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/CastVolumeKeysTest.kt` | 62 | `com.jtech.zemer.playback` | no | 3 | 1 | android.view, org.junit |
...
| `app/src/test/kotlin/com/jtech/zemer/search/ZemerResultMapperTest.kt` | 531 | `com.jtech.zemer.search` | no | 17 | 66 | org.junit |
...
| `innertube/src/main/kotlin/com/metrolist/innertube/YouTube.kt` | 1165 | `com.metrolist.innertube` | no | 65 | 182 | io.ktor, java.net, kotlin.random, kotlinx.coroutines, kotlinx.serialization |
