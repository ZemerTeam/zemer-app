...
| `app/src/main/kotlin/com/jtech/zemer/constants/PreferenceKeys.kt` | 626 | `com.jtech.zemer.constants` | no | 9 | 195 | androidx.annotation, androidx.datastore, java.time |
...
| `app/src/main/kotlin/com/jtech/zemer/db/DatabaseDao.kt` | 1765 | `com.jtech.zemer.db` | no | 65 | 241 | androidx.room, androidx.sqlite, java.text, java.time, java.util, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/extensions/ListExt.kt` | 30 | `com.jtech.zemer.extensions` | no | 2 | 2 |  |
...
| `app/src/main/kotlin/com/jtech/zemer/latestreleases/LatestReleaseCard.kt` | 113 | `com.jtech.zemer.latestreleases` | yes | 27 | 12 | androidx.compose, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/offline/SubsetCorpus.kt` | 175 | `com.jtech.zemer.offline` | no | 0 | 117 |  |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MediaStoreDownloadManager.kt` | 1198 | `com.jtech.zemer.playback` | no | 62 | 141 | android.content, android.media, android.net, androidx.core, dagger.hilt, java.io, java.time, java.util, javax.inject, kotlin.math, kotlinx.coroutines, okhttp3.OkHttpClient, okhttp3.Request, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 3075 | `com.jtech.zemer.playback` | no | 190 | 319 | android.app, android.content, android.database, android.media, android.net, android.os, androidx.core, androidx.datastore, androidx.media3, com.zemer, dagger.hilt, java.io, java.time, java.util, javax.inject, kotlin.time, kotlinx.coroutines, okhttp3.OkHttpClient, org.fcast, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/VideoModeController.kt` | 891 | `com.jtech.zemer.playback` | no | 33 | 123 | android.os, android.view, androidx.media3, kotlinx.coroutines, org.fcast, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/queues/Queue.kt` | 111 | `com.jtech.zemer.playback.queues` | no | 4 | 21 | androidx.media3 |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrBuffer.kt` | 101 | `com.jtech.zemer.playback.sabr` | no | 1 | 27 | java.util |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrDataSource.kt` | 174 | `com.jtech.zemer.playback.sabr` | no | 10 | 49 | android.net, androidx.media3, java.io, java.util, okhttp3.OkHttpClient |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrMessages.kt` | 180 | `com.jtech.zemer.playback.sabr` | no | 4 | 52 |  |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrPlayerResolver.kt` | 196 | `com.jtech.zemer.playback.sabr` | no | 9 | 39 | android.net, com.zemer, kotlinx.coroutines, timber.log |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrProto.kt` | 101 | `com.jtech.zemer.playback.sabr` | no | 1 | 39 | java.io |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrSession.kt` | 187 | `com.jtech.zemer.playback.sabr` | no | 5 | 59 | okhttp3.MediaType, okhttp3.OkHttpClient, okhttp3.Request, okhttp3.RequestBody, timber.log |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrStreamResolver.kt` | 164 | `com.jtech.zemer.playback.sabr` | no | 8 | 28 | android.util, java.io, java.util, kotlinx.coroutines, okhttp3.OkHttpClient, timber.log |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrUmp.kt` | 71 | `com.jtech.zemer.playback.sabr` | no | 0 | 27 |  |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrVideoResolver.kt` | 384 | `com.jtech.zemer.playback.sabr` | no | 16 | 99 | android.net, android.util, com.zemer, java.io, kotlinx.coroutines, timber.log |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrVideoSession.kt` | 199 | `com.jtech.zemer.playback.sabr` | no | 5 | 74 | okhttp3.MediaType, okhttp3.OkHttpClient, okhttp3.Request, okhttp3.RequestBody, timber.log |
| `app/src/main/kotlin/com/jtech/zemer/playback/sabr/SabrVideoStream.kt` | 160 | `com.jtech.zemer.playback.sabr` | no | 8 | 49 | android.net, androidx.media3, java.io, okhttp3.OkHttpClient |
...
| `app/src/main/kotlin/com/jtech/zemer/sync/UserPreferencesRepository.kt` | 694 | `com.jtech.zemer.sync` | no | 39 | 100 | android.content, android.util, androidx.datastore, com.google, dagger.hilt, java.util, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/ChipsRow.kt` | 286 | `com.jtech.zemer.ui.component` | yes | 63 | 15 | android.annotation, androidx.compose, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/PressBounce.kt` | 58 | `com.jtech.zemer.ui.component` | no | 13 | 3 | androidx.compose, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 1539 | `com.jtech.zemer.ui.screens` | yes | 150 | 104 | android.net, androidx.annotation, androidx.compose, androidx.datastore, androidx.hilt, androidx.lifecycle, androidx.navigation, kotlin.math, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/LatestReleasesScreen.kt` | 107 | `com.jtech.zemer.ui.screens` | yes | 34 | 9 | androidx.compose, androidx.hilt, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/NavigationBuilder.kt` | 511 | `com.jtech.zemer.ui.screens` | no | 53 | 8 | androidx.compose, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/library/LibraryAlbumsScreen.kt` | 320 | `com.jtech.zemer.ui.screens.library` | yes | 66 | 24 | androidx.compose, androidx.hilt, androidx.navigation, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AccountSettings.kt` | 517 | `com.jtech.zemer.ui.screens.settings` | yes | 78 | 45 | androidx.compose, androidx.hilt, androidx.navigation, coil3.compose, io.ktor, kotlinx.coroutines, kotlinx.serialization |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AppearanceSettings.kt` | 1124 | `com.jtech.zemer.ui.screens.settings` | yes | 129 | 102 | android.annotation, android.content, androidx.compose, androidx.core, androidx.navigation, kotlin.math, kotlinx.coroutines, me.saket |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/ContentSettings.kt` | 724 | `com.jtech.zemer.ui.screens.settings` | yes | 94 | 66 | android.content, android.os, android.provider, androidx.activity, androidx.compose, androidx.core, androidx.hilt, androidx.navigation, com.google, dagger.hilt, java.text, java.util, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/utils/ShowMediaInfo.kt` | 217 | `com.jtech.zemer.ui.utils` | yes | 48 | 21 | android.text, androidx.annotation, androidx.compose, com.zemer |
...
| `app/src/main/kotlin/com/jtech/zemer/utils/SyncUtils.kt` | 1111 | `com.jtech.zemer.utils` | no | 48 | 137 | android.content, android.util, androidx.datastore, dagger.hilt, java.time, javax.inject, kotlinx.coroutines, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/viewmodels/LibraryViewModels.kt` | 593 | `com.jtech.zemer.viewmodels` | no | 72 | 88 | android.content, androidx.lifecycle, dagger.hilt, java.time, javax.inject, kotlinx.coroutines, timber.log |
...
| `app/src/test/kotlin/com/jtech/zemer/playback/sabr/SabrAudioPickTest.kt` | 46 | `com.jtech.zemer.playback.sabr` | no | 3 | 7 | org.junit |
| `app/src/test/kotlin/com/jtech/zemer/playback/sabr/SabrBufferTest.kt` | 124 | `com.jtech.zemer.playback.sabr` | no | 3 | 17 | org.junit |
| `app/src/test/kotlin/com/jtech/zemer/playback/sabr/SabrMessagesTest.kt` | 150 | `com.jtech.zemer.playback.sabr` | no | 4 | 34 | org.junit |
...
| File | Lines | Package | Compose | Imports | Decls | External import roots |
| --- | ---: | --- | --- | ---: | ---: | --- |
| `innertube/src/main/kotlin/com/metrolist/innertube/InnerTube.kt` | 751 | `com.metrolist.innertube` | no | 48 | 50 | io.ktor, java.net, java.util, kotlinx.serialization, okhttp3.ConnectionPool, okhttp3.Dispatcher |
| `innertube/src/main/kotlin/com/metrolist/innertube/YouTube.kt` | 1002 | `com.metrolist.innertube` | no | 57 | 155 | io.ktor, java.net, kotlin.random, kotlinx.coroutines, kotlinx.serialization |
