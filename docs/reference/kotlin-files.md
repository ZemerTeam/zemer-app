...
## `app` Kotlin files (346)

| File | Lines | Package | Compose | Imports | Decls | External import roots |
| --- | ---: | --- | --- | ---: | ---: | --- |
| `app/src/github/kotlin/com/jtech/zemer/accessibility/ButtonMapperAccessibilityService.kt` | 45 | `com.jtech.zemer.accessibility` | no | 7 | 6 | android.accessibilityservice, android.annotation, android.view |
| `app/src/github/kotlin/com/jtech/zemer/distribution/AccessibilityIntegration.kt` | 22 | `com.jtech.zemer.distribution` | no | 6 | 1 | androidx.compose, androidx.navigation |
| `app/src/github/kotlin/com/jtech/zemer/distribution/UpdateIntegration.kt` | 192 | `com.jtech.zemer.distribution` | yes | 43 | 26 | android.annotation, android.app, android.content, androidx.compose, androidx.core, androidx.navigation, kotlin.time, kotlinx.coroutines |
| `app/src/github/kotlin/com/jtech/zemer/ui/component/UpdateDownloadDialog.kt` | 129 | `com.jtech.zemer.ui.component` | yes | 20 | 7 | androidx.compose, java.io |
| `app/src/github/kotlin/com/jtech/zemer/ui/screens/settings/ButtonSetupScreen.kt` | 374 | `com.jtech.zemer.ui.screens.settings` | yes | 56 | 17 | android.view, androidx.activity, androidx.compose, androidx.hilt, androidx.navigation |
| `app/src/github/kotlin/com/jtech/zemer/ui/screens/settings/UpdaterSettings.kt` | 328 | `com.jtech.zemer.ui.screens.settings` | yes | 63 | 23 | android.content, androidx.compose, androidx.navigation, java.io, kotlinx.coroutines, rikka.shizuku, timber.log |
| `app/src/github/kotlin/com/jtech/zemer/utils/AccessibilityUtils.kt` | 91 | `com.jtech.zemer.utils` | yes | 19 | 18 | android.content, android.database, android.net, android.os, android.provider, android.text, androidx.compose, androidx.lifecycle |
| `app/src/github/kotlin/com/jtech/zemer/utils/ButtonMapperBridge.kt` | 35 | `com.jtech.zemer.utils` | no | 5 | 8 | android.view, java.util |
| `app/src/github/kotlin/com/jtech/zemer/utils/UpdateChecker.kt` | 155 | `com.jtech.zemer.utils` | no | 18 | 53 | android.content, android.net, io.ktor, java.io, kotlinx.coroutines, kotlinx.serialization |
| `app/src/github/kotlin/com/jtech/zemer/utils/Updater.kt` | 55 | `com.jtech.zemer.utils` | no | 5 | 21 | io.ktor, org.json |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/ApkInstallController.kt` | 102 | `com.jtech.zemer.utils.updater` | yes | 15 | 15 | androidx.activity, androidx.compose, java.io, kotlinx.coroutines |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/AppInstaller.kt` | 267 | `com.jtech.zemer.utils.updater` | no | 28 | 41 | android.app, android.content, android.net, android.os, android.provider, androidx.core, com.topjohnwu, dev.rikka, java.io, kotlinx.coroutines, org.lsposed, rikka.shizuku, timber.log |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/AppRestarter.kt` | 30 | `com.jtech.zemer.utils.updater` | no | 1 | 4 | android.content |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/InstallReceiver.kt` | 70 | `com.jtech.zemer.utils.updater` | no | 10 | 7 | android.content, android.os, android.widget, kotlinx.coroutines |
| `app/src/github/kotlin/com/jtech/zemer/utils/updater/Installer.kt` | 24 | `com.jtech.zemer.utils.updater` | no | 2 | 4 | androidx.annotation |
| `app/src/github/kotlin/com/jtech/zemer/viewmodels/ButtonSetupViewModel.kt` | 159 | `com.jtech.zemer.viewmodels` | no | 22 | 29 | android.content, android.view, androidx.datastore, androidx.lifecycle, dagger.hilt, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/App.kt` | 416 | `com.jtech.zemer` | no | 61 | 41 | android.app, android.content, android.os, android.util, android.webkit, android.widget, androidx.datastore, coil3.ImageLoader, coil3.PlatformContext, coil3.SingletonImageLoader, coil3.disk, coil3.network, coil3.request, com.google, com.zemer, dagger.hilt, io.ktor, java.net, java.util, javax.inject, kotlinx.coroutines, kotlinx.serialization, okhttp3.Credentials, okhttp3.OkHttpClient, timber.log |
| `app/src/main/kotlin/com/jtech/zemer/MainActivity.kt` | 2037 | `com.jtech.zemer` | no | 254 | 201 | android.annotation, android.content, android.os, android.view, androidx.activity, androidx.compose, androidx.core, androidx.datastore, androidx.hilt, androidx.lifecycle, androidx.media3, androidx.navigation, coil3.compose, coil3.imageLoader, coil3.request, coil3.toBitmap, com.google, com.valentinilk, dagger.hilt, java.net, java.util, javax.inject, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/db/DatabaseDao.kt` | 1698 | `com.jtech.zemer.db` | no | 59 | 229 | androidx.room, androidx.sqlite, java.text, java.time, java.util, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 1672 | `com.jtech.zemer.playback` | no | 160 | 188 | android.app, android.content, android.media, android.net, android.os, android.widget, androidx.core, androidx.datastore, androidx.media3, dagger.hilt, java.io, java.sql, java.time, java.util, javax.inject, kotlin.time, kotlinx.coroutines, okhttp3.OkHttpClient, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/component/Items.kt` | 1618 | `com.jtech.zemer.ui.component` | yes | 114 | 92 | android.annotation, android.widget, androidx.compose, androidx.media3, coil3.compose, coil3.request, kotlin.math, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/AlbumMenu.kt` | 457 | `com.jtech.zemer.ui.menu` | yes | 60 | 30 | android.annotation, android.content, androidx.compose, androidx.navigation, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/ArtistMenu.kt` | 272 | `com.jtech.zemer.ui.menu` | yes | 54 | 12 | android.content, androidx.compose, coil3.compose, coil3.request, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/PlayerMenu.kt` | 514 | `com.jtech.zemer.ui.menu` | yes | 72 | 27 | android.content, android.media, android.widget, androidx.activity, androidx.annotation, androidx.compose, androidx.media3, androidx.navigation, kotlin.math, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/PlaylistMenu.kt` | 221 | `com.jtech.zemer.ui.menu` | yes | 45 | 11 | android.content, androidx.compose, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/SelectionSongsMenu.kt` | 743 | `com.jtech.zemer.ui.menu` | yes | 55 | 37 | android.annotation, android.content, androidx.compose, androidx.media3, java.time, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/SongMenu.kt` | 633 | `com.jtech.zemer.ui.menu` | yes | 75 | 42 | android.content, android.widget, androidx.activity, androidx.compose, androidx.hilt, androidx.navigation, kotlinx.coroutines |
| `app/src/main/kotlin/com/jtech/zemer/ui/menu/YouTubeAlbumMenu.kt` | 398 | `com.jtech.zemer.ui.menu` | yes | 60 | 17 | android.annotation, android.content, androidx.compose, androidx.media3, androidx.navigation, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/HomeScreen.kt` | 1040 | `com.jtech.zemer.ui.screens` | yes | 102 | 63 | androidx.compose, androidx.hilt, androidx.navigation, kotlin.math, kotlin.random, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/NavigationBuilder.kt` | 348 | `com.jtech.zemer.ui.screens` | no | 42 | 4 | androidx.compose, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/OnboardingScreen.kt` | 2077 | `com.jtech.zemer.ui.screens` | yes | 114 | 113 | android.Manifest, android.annotation, android.content, android.graphics, android.net, android.os, android.provider, androidx.activity, androidx.compose, androidx.core, androidx.datastore, androidx.hilt, androidx.lifecycle, com.airbnb, com.google, dagger.hilt, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/AccountSettings.kt` | 425 | `com.jtech.zemer.ui.screens.settings` | yes | 71 | 45 | android.widget, androidx.compose, androidx.hilt, androidx.navigation, io.ktor, kotlinx.coroutines, kotlinx.serialization |
...
| `app/src/main/kotlin/com/jtech/zemer/utils/SyncUtils.kt` | 733 | `com.jtech.zemer.utils` | no | 34 | 103 | android.content, android.util, androidx.datastore, dagger.hilt, java.time, javax.inject, kotlinx.coroutines |
...
| `app/src/play/kotlin/com/jtech/zemer/distribution/AccessibilityIntegration.kt` | 16 | `com.jtech.zemer.distribution` | no | 4 | 1 | androidx.compose, androidx.navigation |
| `app/src/play/kotlin/com/jtech/zemer/distribution/UpdateIntegration.kt` | 31 | `com.jtech.zemer.distribution` | yes | 7 | 6 | androidx.compose, androidx.navigation |
| `app/src/play/kotlin/com/jtech/zemer/utils/ButtonMapperBridge.kt` | 15 | `com.jtech.zemer.utils` | no | 1 | 3 |  |
