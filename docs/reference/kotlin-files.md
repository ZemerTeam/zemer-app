...
| `app/src/main/kotlin/com/jtech/zemer/constants/PlaybackMode.kt` | 17 | `com.jtech.zemer.constants` | no | 0 | 1 |  |
| `app/src/main/kotlin/com/jtech/zemer/constants/PreferenceKeys.kt` | 586 | `com.jtech.zemer.constants` | no | 9 | 181 | androidx.annotation, androidx.datastore, java.time |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MediaStoreDownloadManager.kt` | 931 | `com.jtech.zemer.playback` | no | 52 | 110 | android.content, android.media, android.net, androidx.core, dagger.hilt, java.io, java.time, java.util, javax.inject, kotlin.math, kotlinx.coroutines, okhttp3.OkHttpClient, okhttp3.Request, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/MusicService.kt` | 2450 | `com.jtech.zemer.playback` | no | 176 | 255 | android.app, android.content, android.media, android.net, android.os, androidx.core, androidx.datastore, androidx.media3, com.zemer, dagger.hilt, java.io, java.sql, java.time, java.util, javax.inject, kotlin.time, kotlinx.coroutines, okhttp3.OkHttpClient, org.fcast, timber.log |
...
| `app/src/main/kotlin/com/jtech/zemer/playback/relay/RelayDataSourceFactory.kt` | 42 | `com.jtech.zemer.playback.relay` | no | 9 | 4 | android.content, androidx.core, androidx.media3, okhttp3.OkHttpClient |
| `app/src/main/kotlin/com/jtech/zemer/playback/relay/RelayDownload.kt` | 55 | `com.jtech.zemer.playback.relay` | no | 0 | 5 |  |
| `app/src/main/kotlin/com/jtech/zemer/playback/relay/RelayStream.kt` | 48 | `com.jtech.zemer.playback.relay` | no | 1 | 8 |  |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/GenreScreen.kt` | 599 | `com.jtech.zemer.ui.screens` | yes | 102 | 27 | androidx.compose, androidx.hilt, androidx.navigation, coil3.compose, coil3.request, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/artist/ArtistScreen.kt` | 865 | `com.jtech.zemer.ui.screens.artist` | yes | 124 | 46 | androidx.compose, androidx.hilt, androidx.navigation, coil3.compose, com.valentinilk |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/search/OnlineSearchResult.kt` | 465 | `com.jtech.zemer.ui.screens.search` | yes | 82 | 31 | androidx.compose, androidx.hilt, androidx.navigation, kotlinx.coroutines |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/screens/settings/StreamSourceSettings.kt` | 264 | `com.jtech.zemer.ui.screens.settings` | yes | 55 | 24 | androidx.compose, androidx.navigation |
...
| `app/src/main/kotlin/com/jtech/zemer/ui/utils/ShowMediaInfo.kt` | 210 | `com.jtech.zemer.ui.utils` | yes | 52 | 19 | android.text, androidx.annotation, androidx.compose, com.zemer |
