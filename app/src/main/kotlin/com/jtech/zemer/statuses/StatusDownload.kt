 ...
 * still classify it correctly (and [textBody] keeps the original words for the saved viewer's copy button).
 */
data class StatusDownload(
    ...
    val caption: String?,
    val textBody: String?,          // original body for a text status (the saved viewer copies it)
